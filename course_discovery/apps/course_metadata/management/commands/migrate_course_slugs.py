...
class Command(BaseCommand):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.course_type = 'open-course'
        self.product_source = 'edx'
        ...
        if limit:
            ...
            if self.course_type == CourseType.EXECUTIVE_EDUCATION_2U:
                courses = Course.everything.filter(
                    product_source__slug=self.product_source, draft=True, type__slug=CourseType.EXECUTIVE_EDUCATION_2U
                )[:limit]
            else:
    ...
    def _get_courses_from_uuids(self, course_uuids):
        ...
        if self.course_type == CourseType.EXECUTIVE_EDUCATION_2U:
            return Course.everything.filter(
                product_source__slug=self.product_source, uuid__in=valid_course_uuids,
                draft=True, type__slug=CourseType.EXECUTIVE_EDUCATION_2U
            )
